...
| Shell top tabs | `UISegmentedControl` laid over MAUI's tab strip | M3 primary tabs: `primary` label and indicator, 1 dp `outlineVariant` divider, fixed tabs sharing the width (scrollable above four) |
